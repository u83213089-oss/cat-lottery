  ...
  return (
    ...
    >
      ...
      <img
        src="/decor/plum.png"
        alt=""
        className="pointer-events-none select-none fixed left-0 top-0 w-[520px] -translate-x-[45px] -translate-y-[40px] opacity-95"
      />
      <img
...
function Row({ label, value }: { label: string; value: string }) {
  return (
    <div className="flex items-baseline gap-4">
      <div
        className="text-[40px] font-black whitespace-nowrap"
        style={{ color: "#000" }}
      >
        {label}
      </div>
      <div className="text-[40px] font-black truncate" style={{ color: "#000" }}>
        {value}
      </div>
    </div>
  );
